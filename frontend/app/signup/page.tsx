        ...
        >
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-full border border-slate-800 bg-slate-900/50 px-6 py-3 text-sm font-medium text-slate-200 transition hover:bg-slate-800"
            >
